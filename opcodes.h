...
enum
{
  accu=0, imm, aabs, zp, zpx, zpy, absx, absy,
...
opcodes all_nmos6502[] =
{
  ...
  {S_NOOP, aabs}, {S_ORA,  aabs}, {S_ASL,  aabs}, {S_SLOR, aabs},
  ...
  {S_JSR,  aabs}, {S_AND, indx}, {S_STP, impl}, {S_RLAN,indx},
  {S_BIT,   zp}, {S_AND,   zp}, {S_ROL,   zp}, {S_RLAN,  zp},
  {S_PLP, impl}, {S_AND,  imm}, {S_ROL, accu}, {S_ANC,  imm},
  {S_BIT,  aabs}, {S_AND,  aabs}, {S_ROL,  aabs}, {S_RLAN, aabs},
  ...
  {S_JMP,  aabs}, {S_EOR,  aabs}, {S_LSR,  aabs}, {S_SREO, aabs},
  ...
  {S_JMP, iabs}, {S_ADC,  aabs}, {S_ROR,  aabs}, {S_RRAD, aabs},
  ...
  {S_STY,  aabs}, {S_STA,  aabs}, {S_STX,  aabs}, {S_STAX, aabs},
  ...
  {S_LDY,  aabs}, {S_LDA,  aabs}, {S_LDX,  aabs}, {S_LDAX, aabs},
  ...
  {S_CPY,  aabs}, {S_CMP,  aabs}, {S_DEC,  aabs}, {S_DCMP, aabs},
  ...
  {S_CPX,  aabs}, {S_SBC,  aabs}, {S_INC,  aabs}, {S_ISBC, aabs},
...
opcodes useful_nmos6502[] =
{
  ...
  {S_PHP, impl}, {S_ORA,  imm}, {S_ASL, accu}, {S_ANC,  imm},
  {S_ILLEGAL,0}, {S_ORA,  aabs}, {S_ASL,  aabs}, {S_SLOR, aabs},
  ...
  {S_JSR,  aabs}, {S_AND, indx}, {S_ILLEGAL,0}, {S_RLAN,indx},
  {S_BIT,   zp}, {S_AND,   zp}, {S_ROL,   zp}, {S_RLAN,  zp},
  {S_PLP, impl}, {S_AND,  imm}, {S_ROL, accu}, {S_ANC,  imm},
  {S_BIT,  aabs}, {S_AND,  aabs}, {S_ROL,  aabs}, {S_RLAN, aabs},
...
opcodes standard_nmos6502[] =
{
  ...
  {S_PHP, impl}, {S_ORA,  imm}, {S_ASL, accu}, {S_ILLEGAL,0},
  {S_ILLEGAL,0}, {S_ORA,  aabs}, {S_ASL,  aabs}, {S_ILLEGAL,0},
  ...
  {S_JSR,  aabs}, {S_AND, indx}, {S_ILLEGAL,0}, {S_ILLEGAL,0},
  {S_BIT,   zp}, {S_AND,   zp}, {S_ROL,   zp}, {S_ILLEGAL,0},
  {S_PLP, impl}, {S_AND,  imm}, {S_ROL, accu}, {S_ILLEGAL,0},
  {S_BIT,  aabs}, {S_AND,  aabs}, {S_ROL,  aabs}, {S_ILLEGAL,0},
  ...
  {S_PHA, impl}, {S_EOR,  imm}, {S_LSR, accu}, {S_ILLEGAL,0},
  {S_JMP,  aabs}, {S_EOR,  aabs}, {S_LSR,  aabs}, {S_ILLEGAL,0},
  ...
  {S_PLA, impl}, {S_ADC,  imm}, {S_ROR, accu}, {S_ILLEGAL,0},
  {S_JMP, iabs}, {S_ADC,  aabs}, {S_ROR,  aabs}, {S_ILLEGAL,0},
  ...
  {S_DEY, impl}, {S_ILLEGAL,0}, {S_TXA, impl}, {S_ILLEGAL,0},
  {S_STY,  aabs}, {S_STA,  aabs}, {S_STX,  aabs}, {S_ILLEGAL,0},
  {S_BCC,  rel}, {S_STA, indy}, {S_ILLEGAL,0}, {S_ILLEGAL,0},
  ...
  {S_TAY, impl}, {S_LDA,  imm}, {S_TAX, impl}, {S_ILLEGAL,0},
  {S_LDY,  aabs}, {S_LDA,  aabs}, {S_LDX,  aabs}, {S_ILLEGAL,0},
  ...
  {S_INY, impl}, {S_CMP,  imm}, {S_DEX, impl}, {S_ILLEGAL,0},
  {S_CPY,  aabs}, {S_CMP,  aabs}, {S_DEC,  aabs}, {S_ILLEGAL,0},
  ...
  {S_INX, impl}, {S_SBC,  imm}, {S_NOP, impl}, {S_ILLEGAL,0},
  {S_CPX,  aabs}, {S_SBC,  aabs}, {S_INC,  aabs}, {S_ILLEGAL,0},
...
opcodes r65c02[] =
{
  ...
  {S_PHP, impl}, {S_ORA,  imm}, {S_ASL, accu}, {S_ILLEGAL,0},
  {S_TSB,  aabs}, {S_ORA,  aabs}, {S_ASL,  aabs}, {S_BBR0,zrel},
  ...
  {S_TRB,  aabs}, {S_ORA, absx}, {S_ASL, absx}, {S_BBR1,zrel},

  {S_JSR,  aabs}, {S_AND, indx}, {S_ILLEGAL,0}, {S_ILLEGAL,0},
  {S_BIT,   zp}, {S_AND,   zp}, {S_ROL,   zp}, {S_RMB2,  zp},
  {S_PLP, impl}, {S_AND,  imm}, {S_ROL, accu}, {S_ILLEGAL,0},
  {S_BIT,  aabs}, {S_AND,  aabs}, {S_ROL,  aabs}, {S_BBR2,zrel},
  ...
  {S_PHA, impl}, {S_EOR,  imm}, {S_LSR, accu}, {S_ILLEGAL,0},
  {S_JMP,  aabs}, {S_EOR,  aabs}, {S_LSR,  aabs}, {S_BBR4,zrel},
  ...
  {S_PLA, impl}, {S_ADC,  imm}, {S_ROR, accu}, {S_ILLEGAL,0},
  {S_JMP, iabs}, {S_ADC,  aabs}, {S_ROR,  aabs}, {S_BBR6,zrel},
  ...
  {S_STY,  aabs}, {S_STA,  aabs}, {S_STX,  aabs}, {S_BBS0,zrel},
  {S_BCC,  rel}, {S_STA, indy}, {S_STA,  ind}, {S_ILLEGAL,0},
  {S_STY,  zpx}, {S_STA,  zpx}, {S_STX,  zpy}, {S_SMB1,  zp},
  {S_TYA, impl}, {S_STA, absy}, {S_TXS, impl}, {S_ILLEGAL,0},
  {S_STZ,  aabs}, {S_STA, absx}, {S_STZ, absx}, {S_BBS1,zrel},

  {S_LDY,  imm}, {S_LDA, indx}, {S_LDX,  imm}, {S_ILLEGAL,0},
  {S_LDY,   zp}, {S_LDA,   zp}, {S_LDX,   zp}, {S_SMB2,  zp},
  {S_TAY, impl}, {S_LDA,  imm}, {S_TAX, impl}, {S_ILLEGAL,0},
  {S_LDY,  aabs}, {S_LDA,  aabs}, {S_LDX,  aabs}, {S_BBS2,zrel},
  ...
  {S_INY, impl}, {S_CMP,  imm}, {S_DEX, impl}, {S_ILLEGAL,0},
  {S_CPY,  aabs}, {S_CMP,  aabs}, {S_DEC,  aabs}, {S_BBS4,zrel},
  ...
  {S_INX, impl}, {S_SBC,  imm}, {S_NOP, impl}, {S_ILLEGAL,0},
  {S_CPX,  aabs}, {S_SBC,  aabs}, {S_INC,  aabs}, {S_BBS6,zrel},
